...
.customer-info-container {
    margin-top: 1.5rem;
    margin-left: 1.5rem;
    border-bottom: 1px solid #000; /* Replace #000 with your desired border color */
}
...
.table-container th, .table-container td {
    border: 1px solid #ddd; /* Replace #ddd with your desired border color */
    padding: 8px;
    text-align: left;
}

.table-container th {
    background-color: #f2f2f2; /* Replace #f2f2f2 with your desired header background color */
}
